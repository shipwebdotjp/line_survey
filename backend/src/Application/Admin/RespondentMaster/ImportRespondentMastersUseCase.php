        ...
        while (($data = fgetcsv($stream)) !== false) {
            ...
            try {
                ...
                if ($existing) {
                    ...
                    if ($existing['line_display_name'] !== $record['line_display_name']) {
                ...
                error_log(sprintf('Database error importing row %d: %s', $rowIndex, $e->getMessage()));
                $errors[] = ['row' => $rowIndex, 'reason' => 'Database error occurred while importing this row'];
            }
        }
