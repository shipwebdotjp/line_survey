...
use App\Presentation\Http\Admin\Respondent\GetRespondentAction;
use App\Presentation\Http\Admin\Respondent\UpdateRespondentAction;
...
return function (App $app) {
    ...
    $app->group('/api/admin', function (RouteCollectorProxy $group) {
        ...
        $group->get('/respondents/{id:[0-9]+}', GetRespondentAction::class);
        $group->put('/respondents/{id:[0-9]+}', UpdateRespondentAction::class);
