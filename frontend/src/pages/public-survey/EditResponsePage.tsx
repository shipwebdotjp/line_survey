...
import type { SurveyResponse, SaveResponseResult } from '../../features/survey/types';
...
const EditResponsePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const responseRes = await fetch(`/api/surveys/public/${public_id}/responses/${edit_token}?id_token=${idToken}`);
  ...
  const handleUpdateComplete = async (sender: any) => {
