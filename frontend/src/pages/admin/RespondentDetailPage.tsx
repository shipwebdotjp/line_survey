...
import type { RespondentDetail, RespondentResponseHistory } from '../../features/admin/respondents/types';
        ...
        <table className="admin-table">
          ...
          <tbody>
            {respondent.responses.length === 0 ? (
              ...
              respondent.responses.map((history: RespondentResponseHistory) => (
